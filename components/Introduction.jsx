...
function Introduction() {
  return (
    <section id='introduction' className='h-[94vh] pt-8 md:px-10 text-white flex flex-col items-center md:flex-row md:justify-around'>
        ...
        <div className='flex flex-col h-full md:h-max items-center md:items-start md:space-y-4 mt-4 md:order-1 '>
            ...
            <span className='text-sm md:text-lg text-gray-300'>Student - Application Development</span>
