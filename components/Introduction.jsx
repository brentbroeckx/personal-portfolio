  ...
  return (
    <section id='introduction' className='h-screen text-white flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center mt-4'>
            ...
            <button class="bg-blue-400 hover:bg-blue-600 text-gray-800 font-bold py-2 px-4 mt-4 rounded inline-flex items-center">
        ...
        <div className='h-full mt-10'>
            <Link href={'#about'}>
            <svg className='animate-bounce h-6 w-6' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
